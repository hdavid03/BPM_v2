...
class PeakFilter:
    ...
    #__B_COEFS = [0.99686334, -2.99059001,  2.99059001, -0.99686334]
    #__A_COEFS = [-2.99371682,  2.98745336, -0.99373651] 

    def __init__(self):
        self.__len_x = len(self.__B_COEFS)
        self.__len_y = len(self.__A_COEFS)
